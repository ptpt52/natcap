...
list_cli()
{
	cat /proc/net/nf_conntrack | grep "udp.*src=.*dst=127.255.255.254 sport=.* dport=65535 .*src=127.255.255.254 dst=.* sport=65535 dport=.*" | while read _ _ _ _ timeout src _ sport _ _ _ _ _ _ _ _ _ _ mark _ _; do
